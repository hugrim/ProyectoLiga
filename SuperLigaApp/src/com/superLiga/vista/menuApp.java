...
import exceptions.ExceptionsTablaHash;
	...
	public static void main (String[]args){
	    ...
	    do{
	        ...
	        try{
	            switch (dato){
	                case "1":
	                       ejecutar(SondeoTablaCuadratica.class);
	                        break;
	                    case "2":
	                        System.out.println( "Hash Table Lineal\n");
	                        ejecutar(SondeoLineal.class);
	                        break;
	                    case "3":
	                    ...
	                    case "5":
	                        ...
	                        break;
	                    default:
	                        System.out.println("Seleccion invalida, debe seleccionar alguna de las opciones validas (1 al 5)\n");
	                        break;
	                }
	    ...
	    public static Hashable obtenerObjetoHasheableConLeyenda(String leyenda){
	        ...
	        Hashable object = new Datos(Integer.parseInt(valor));
	        return object;
	    }

	    @SuppressWarnings("unchecked")
		public static void ejecutar(@SuppressWarnings("rawtypes") Class claseHash) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
	        ...
	        do {
	            ...
	            switch (opcion) {
	                case 1:
	                    do {
	                        otro = false;
	                        tabla.insertar(obtenerObjetoHasheableConLeyenda( "Ingrese el dato a agregar (numerico por favor):"));
	                        System.out.println( "Desea agregar uno nuevo? (s/N)" );
	                        System.out.print("\033[1m" + "> " + "\033[0m");
	                ...
	                case 3:
	                    do {
	                        otro = false;
	                        tabla.eliminar(obtenerObjetoHasheableConLeyenda( "Ingrese el dato que desea borrar" ));
	                        System.out.println( "Desea borrar otro dato? (s/N)" );
	                        System.out.print("\033[1m" + "> " + "\033[0m");
	                        if(sc.nextLine().toUpperCase().equals("S")){
	                            otro = true;
	                        }
